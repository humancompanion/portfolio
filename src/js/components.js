...
var $contactCard = $('[data-object="contact-card"]');

$contactCard.on('click', '[data-behavior]', function (event) {
  var $el = $(this),
...
// ################## ACTIONS ###################
$contactCard.on('contact-card.flip', function (event, opts) {
  opts.object.addClass('is-flipped');
});

$contactCard.on('contact-card.flip-revert', function (event, opts) {
